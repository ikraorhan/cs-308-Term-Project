...
class Order(models.Model):
    ...
    # Legacy fields (nullable for backward compatibility with old single-product orders)
...
class OrderItem(models.Model):
    """Items in an order - allows multiple products per order"""
    ...
    def __str__(self):
        return f"{self.product_name} x{self.quantity} in Order {self.order.delivery_id}"
